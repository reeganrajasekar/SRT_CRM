            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if($_SERVER['PHP_SELF'] == '/admin/invoice.php'){ echo 'active'; } ?>" href="invoice.php" aria-expanded="false">
                                <i class="mdi me-2 mdi-file-multiple"></i><span class="hide-menu">Invoice</span>
                            </a>
                        </li>
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if($_SERVER['PHP_SELF'] == '/admin/product.php'){ echo 'active'; } ?>"  href="product.php" aria-expanded="false">
                                <i class="mdi me-2 mdi-barcode-scan"></i><span class="hide-menu">Product</span>
                            </a>
                        </li>
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if($_SERVER['PHP_SELF'] == '/admin/client.php'){ echo 'active'; } ?>" href="client.php" aria-expanded="false">
                                <i class="mdi me-2 mdi-account-multiple"></i><span class="hide-menu">Client</span>
                            </a>
                        </li>
                        <li class="sidebar-item"> 
                            <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if($_SERVER['PHP_SELF'] == '/admin/payment.php'){ echo 'active'; } ?>" href="payment.php" aria-expanded="false">
