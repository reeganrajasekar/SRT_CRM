            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-12 col-12 col-sm-12 col-lg-12 align-self-center" style="display:flex;flex-direction:row;justify-content:space-between">
                        ...
                        <button data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-success d-md-inline-block btn-sm text-white"><i class="mdi mdi-plus"></i> Add User</button>
                    </div>
                </div>
                        ...
                        <div class="modal-body">
                            <form action="/admin/create/client.php" method="POST">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" required id="code" placeholder="Enter Name" name="name">
                                    <label for="code">User Name</label>
                                </div>

                                <div class="form-floating mt-3 mb-3">
                                    <input type="text" class="form-control" required id="name" placeholder="Enter Mobile No" name="mob">
                                    <label for="name">Mobile/Phone No</label>
                                </div>

                                <div class="form-floating mt-3 mb-3"> 
                                    <input type="text" class="form-control" required id="prize" placeholder="Enter address" name="address">
                                                    ...
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="/admin/edit/client.php" method="POST">
                                                                ...
                                                                <div class="form-floating mb-3">
                                                                    <input type="text" class="form-control" value="<?php echo($row["name"])?>" required id="code" placeholder="Enter Name" name="name">
                                                                    <label for="code">User Name</label>
                                                                </div>

                                                                <div class="form-floating mt-3 mb-3">
                                                                    <input type="text" class="form-control" value="<?php echo($row["mob"])?>" required id="name" placeholder="Enter Mobile No" name="mob">
                                                                    <label for="name">Mobile/Phone No</label>
                                                                </div>

                                                                <div class="form-floating mt-3 mb-3"> 
                                                                    <input type="text" class="form-control" value="<?php echo($row["address"])?>" required id="prize" placeholder="Enter address" name="address">
                                                                    <label for="prize">Address</label>
                                                                </div>
